...
//				if (debugMode == 1) Log.info((diff > factorA ? "X" : " "));
//				if (debugMode == 2) Log.info(diff + (x < comparex - 1 ? "," : ""));
			}
//			if (debugMode > 0) System.out.println("|");
	...
	public int getAverageBrightness(BufferedImage img) {
